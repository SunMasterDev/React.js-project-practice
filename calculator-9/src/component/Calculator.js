import "./Calculator.css" // C ตัวใหญ่ 
import { useState } from "react";

const Calculator =()=>{
    const [inputValue,setInputValue]=useState('0') //[] ไม่ใช่ {}
    ...
    const reset =()=>{ //รีเซ็ตค่า
        setInputValue("0")
    }

    const calculate=()=>{
        // eslint-disable-next-line 
       let result=eval(inputValue)  //eval ใช้คำนวณตัวเลข อัตโนมัติ
